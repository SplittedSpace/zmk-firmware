 ...
 */
    ...
    const led_widget_t led_widgets[LED_EVENT_SIZE][CONFIG_ZMK_LED_WIDGETS_MAX_WIDGET_NUM] = {
        ...
        [LED_EVENT_BOOT] = {
            //{.arg = 0, .priority = 100, .period = 0, .cmd_len = 5, {CMD(80, 100, 0, 0, 0), WAIT(80), CMD(80, 100, 0, 0, 0), WAIT(80), CMD(80, 100, 0, 0, 0)}},
        },

        // Automatically show battery status with interval
        // [LED_EVENT_BATTERY] = {
        //     {.arg = 30, .priority = 10, .period = 120000, .cmd_len = 1, {CMD(1000, 0, 100, 0, 0)}},
        //     {.arg = 60, .priority = 11, .period = 120000, .cmd_len = 1, {CMD(1000, 0, 100, 100, 0)}},
        //     {.arg = 80, .priority = 12, .period = 120000, .cmd_len = 1, {CMD(1000, 0, 100, 100, 100)}},
        //     {.arg = 100, .priority = 13, .period = 120000, .cmd_len = 1, {CMD(1000, 100, 100, 100, 100)}},
        // },
